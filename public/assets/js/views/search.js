...
const SearchView = (() => {
                    ...
                    <div class="max-w-4xl mx-auto">
                            ...
                            <form id="search-form" class="space-y-6">
                                ...
                                <div class="flex items-center justify-between text-sm text-gray-400">
                                    <div class="flex items-center gap-2">
                                        ...
                                        <span>Search runs automatically as you type</span>
                                    </div>
                        ...
                        <div id="search-results">
                            <div class="text-center py-12">
                                ...
                                <p class="text-gray-500">Enter a national ID number to look up couder information</p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    function _setupEventListeners() {
        ...
        if (searchInput) {
            ...
            searchInput.addEventListener('focus', () => {
                if (searchStatus) {
                    searchStatus.textContent = 'Type at least 3 digits';
                }
            });
        }
    }
    ...
    async function _searchCouder(searchTerm) {
        ...
        try {
            if (searchStatus) {
                searchStatus.textContent = 'Searching for couder...';
            }
            ...
            _showError('Error searching for couder: ' + error.message);
            if (searchStatus) {
                ...
                <div class="relative z-10">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                        <div class="bg-gray-700/50 backdrop-blur-sm rounded-lg p-4 text-center group/item hover:bg-gray-700/70 transition-all">
                            <span class="text-gray-400 text-sm">Campus</span>
            ...
            <div class="bg-gray-800/50 backdrop-blur-sm rounded-xl shadow-xl p-8 border border-gray-700/50">
                <div class="flex items-center justify-between mb-6">
                    <div class="flex items-center gap-3">
                        ...
                        <h3 class="text-xl font-bold text-white">Historial de Interventions</h3>
                ...
                ${_interventions.length === 0 ? `
                    <div class="text-center py-8">
                        ...
                        <h4 class="text-xl font-semibold text-white mb-2">Sin Interventions</h4>
                        <p class="text-gray-400">Este couder no tiene interventions registradas</p>
                    </div>
                ` : `
                    <div class="space-y-4">
                        ...
                        ${_interventions.length > 5 ? `
                            <div class="text-center pt-4">
                                <button onclick="Router.navigate('couder', { cc: '${_currentCouder.national_id}' })" class="text-blue-400 hover:text-blue-300 transition-colors">
                                    Ver ${_interventions.length - 5} interventions más →
                                </button>
                            </div>
                        ` : ''}
                    </div>
    ...
    function _showNotFound(searchTerm) {
        ...
        resultsContainer.innerHTML = `
            <div class="text-center py-12">
                ...
                <p class="text-gray-400">No couder found with national ID: <span class="font-mono bg-gray-700/50 px-2 py-1 rounded">${searchTerm}</span></p>
                <div class="mt-6 space-y-2 text-sm text-gray-500">
                    <p>Please verify that:</p>
                    <ul class="list-disc list-inside space-y-1">
                        <li>The national ID number is spelled correctly</li>
