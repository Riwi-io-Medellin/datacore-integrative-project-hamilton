/* =============================================================
   ...
   Shows global KPIs + campuses with real backend data + interactions
   ============================================================= */
...
const DashboardView = (() => {
                    ...
                    <div class="p-6">
                        <div id="dash-content">
                            <div class="text-center py-12">
                                ...
                                <p class="text-gray-400">Fetching real-time system data</p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    function renderContent({ global, campuses }) {
        console.log('=== RENDERING DASHBOARD ===');
        console.log('Global data:', global);
        console.log('Campuss data:', campuses);
        console.log('========================');
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            <div class="group relative overflow-hidden bg-gradient-to-br from-green-500 to-teal-600 rounded-xl p-6 shadow-lg hover:shadow-2xl transition-all duration-300 hover:scale-105 cursor-pointer" onclick="DashboardView._showKpiDetails('active')">
                ...
                <div class="relative z-10">
                    ...
                    <div class="text-green-100 text-sm">Click for details</div>
                </div>
            </div>
        </div>

        <!-- Interactive Campuss Section -->
        <div class="mb-6">
            <div class="flex items-center justify-between mb-4">
                <div class="flex items-center gap-3">
                    ...
                    <h2 class="text-2xl font-bold text-white">Campuss</h2>
                    <span class="bg-blue-600/20 text-blue-400 px-3 py-1 rounded-full text-sm">${campuses?.length || 0} campuses</span>
                </div>
                <div class="flex gap-2">
                    <button onclick="DashboardView._sortCampuss('name')" class="text-gray-400 hover:text-white transition-colors px-3 py-2 rounded-lg hover:bg-gray-700/50">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="sede-card group bg-gray-800/50 backdrop-blur-sm rounded-xl p-6 border border-gray-700/50 hover:border-purple-600/50 transition-all duration-300 hover:scale-105 hover:shadow-2xl cursor-pointer relative" 
                ...
                <div class="relative z-10">
                    <div class="flex items-start justify-between mb-4">
                        <div>
                            <h3 class="text-xl font-bold text-white mb-2 group-hover:text-purple-300 transition-colors">${sede.name || 'Campus'}</h3>
            ...
            <div class="col-span-2 text-center py-12">
                ...
                <h3 class="text-xl font-semibold text-gray-300 mb-2">No hay campuses registradas</h3>
                <p class="text-gray-500">No se encontraron campuses en el sistema</p>
            </div>
            `}
        </div>
    `;
        ...
        _addCampusClickListeners();
    }

    function _addCampusClickListeners() {
        ...
        cards.forEach(card => {
            ...
            card.onclick = function(e) {
                console.log('Campus card clicked:', sedeId);
    ...
    function _sortCampuss(sortBy) {
        if (sortBy === 'name') {
            _sedeData.sort((a, b) => (a.name || '').localeCompare(b.name || ''));
        }
        
        // Re-render with sorted data
        renderContent({ global: _globalData, campuses: _sedeData });
