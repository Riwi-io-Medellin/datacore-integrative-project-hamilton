                ...
                <div class="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white">
                    ...
                    <div class="p-6">
                        <div class="flex items-center gap-4 mb-6">
                            ...
                            <h2 class="text-2xl font-bold text-white">Cohort Clans</h2>
                        </div>
                        ...
                        <div id="cohort-content">
                            <div class="text-center py-12">
                                ...
                                <p class="text-gray-400">Fetching cohort information and clans</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        content.innerHTML = `
                    ...
                    <div class="flex items-center justify-between mb-8">
                        <div>
                            <div class="flex items-center gap-3 mb-4">
                                ...
                                <h1 class="text-4xl font-bold bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">Clans ${cohort.name}</h1>
                            </div>
                            <p class="text-gray-400 text-lg">Groups available at ${cohort.name}</p>
                        </div>
                        <div class="flex items-center gap-3">
                            <div class="bg-blue-600/80 backdrop-blur-sm px-4 py-2 rounded-lg group-hover:scale-110 transition-transform">
                                <span class="text-white font-medium">Active Cohort</span>
                            </div>
                            <div class="bg-purple-600/80 backdrop-blur-sm px-4 py-2 rounded-lg group-hover:scale-110 transition-transform">
                                <span class="text-white font-medium">${cohort.route_name === 'basica' ? 'Basic Track' : 'Advanced Track'}</span>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="bg-gray-700/50 backdrop-blur-sm rounded-lg p-6 border border-gray-600/50 group/item hover:bg-gray-700/70 transition-all">
                            ...
                            <div class="space-y-3">
                                <div class="flex items-center justify-between group/subitem">
                                    <span class="text-gray-400 group/subitem:text-gray-300 transition-colors">Total Clans:</span>
            ...
            <div class="mb-6">
                <div class="flex items-center justify-between mb-4">
                    <div class="flex items-center gap-3">
                        ...
                        <h2 class="text-2xl font-bold text-white">Clans</h2>
                        <span class="bg-blue-600/20 text-blue-400 px-3 py-1 rounded-full text-sm">${(morning?.length || 0) + (afternoon?.length || 0)} clans</span>
                    </div>
            ...
            <div class="mb-8">
                <h3 class="text-xl font-bold text-white mb-4 flex items-center gap-3">
                    ...
                    <span class="bg-yellow-600/20 text-yellow-400 px-3 py-1 rounded-full text-sm">${morning.length} clans</span>
                </h3>
            ...
            <div class="mb-8">
                <h3 class="text-xl font-bold text-white mb-4 flex items-center gap-3">
                    ...
                    <span class="bg-blue-600/20 text-blue-400 px-3 py-1 rounded-full text-sm">${afternoon.length} clans</span>
                </h3>
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="text-center py-12">
                ...
                <h3 class="text-xl font-semibold text-gray-300 mb-2">No hay clans registrados</h3>
                <p class="text-gray-500">No se encontraron clans en este corte</p>
            </div>
            ` : ''}
        `;
