...
(function() {
    ...
    console.log('[GlobalClickHandler] Signing in...');
    ...
    function init() {
        ...
        document.addEventListener('click', function(e) {
            ...
            // Check if the click was on an element with onclick
            ...
            // DashboardView._sortCampuss
            if (onclickValue.includes('DashboardView._sortCampuss')) {
                e.preventDefault();
                e.stopPropagation();
                console.log('[GCH] Sort campuses');
                if (window.DashboardView && window.DashboardView._sortCampuss) {
                    window.DashboardView._sortCampuss('name');
                }
                return false;
            }
