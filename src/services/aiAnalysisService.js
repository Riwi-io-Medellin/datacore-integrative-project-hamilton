...
const AiAnalysisService = {
    ...
    async generateAnalysis(couderId, periodFilter = null, periodLabel = 'all') {
        ...
        if (!interventions.length) {
            throw new AppError('No hay interventions para el periodo seleccionado', 400);
        }
        ...
        const systemPrompt =
            'Eres un asistente clinico especializado en analisis de historial de interventions. ' +
        ...
        const userPrompt =
            `Analiza el siguiente historial de interventions:\n\n` +
            ...
            `3. "suggestions": array con 3 a 5 recomendaciones concretas para futuras interventions.\n\n` +
